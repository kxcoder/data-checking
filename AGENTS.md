...
| `data-checking-infrastructure` | Kafka 消费者、MyBatis-Plus Mapper、SpEL/Groovy 引擎、缓存 | domain + application |
| `data-checking-adapter` | REST 控制器、Dubbo RPC 实现 | api + application (+ infrastructure 可选) |
